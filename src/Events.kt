...
val events = arrayOf(
        ...
        FindWeaponEvent("Вы нашли посреди дороги окровавленый кинжал, будете брать?", "Что нибудь", "Великолепно!",
                Dagger()),
        FindWeaponEvent("Меч! Будете брать?", "Действительно, и зачем вам меч?", "Отлично, ну и где же монстры?",
                Sword()),
        FindWeaponEvent("Вампирский Меч! Будете брать?", "Странный вы человек…", "Вот это клинок!",
                VampiricSword())
